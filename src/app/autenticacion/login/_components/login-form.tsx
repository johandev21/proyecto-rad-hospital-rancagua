...
import FormImage from "../../../../../public/hospital-auth-form.jpg";
...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0 bg-card/90">
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center text-sm">
                ...
                <Link href="/autenticacion/registracion" className="underline underline-offset-4">
                  Regístrate
                </Link>
              </div>
            </div>
